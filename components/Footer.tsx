...
/*
  ─── SOCIAL LINKS ───
  X and Facebook were removed: both pointed at REPLACE_USERNAME placeholders,
  i.e. a broken outbound link on every page. Add them back only with a real
  profile URL — never a placeholder.
*/
const socials = [
