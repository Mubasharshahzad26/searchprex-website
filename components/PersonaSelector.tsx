...
const businessTypes = [
  { id: "law-firm", label: "Law Firm", color: "#7F77DD", bg: "#EEEDFE", href: "/services/law-firm-seo" },
  { id: "local", label: "Local Business", color: "#1D9E75", bg: "#E1F5EE", href: "/services/local-seo" },
  { id: "ecommerce", label: "E-Commerce", color: "#D85A30", bg: "#FAECE7", href: "/services/ecommerce-seo" },
  { id: "medical", label: "Medical / Health", color: "#E24B4A", bg: "#FCEBEB", href: "/services/medical-seo" },
  { id: "real-estate", label: "Real Estate", color: "#185FA5", bg: "#E6F1FB", href: "/services/real-estate-seo" },
  { id: "other", label: "Other Business", color: "#888780", bg: "#F1EFE8", href: "/services" },
];
...
export default function PersonaSelector() {
  ...
  const [selectedBusiness, setSelectedBusiness] = useState<string>("law-firm");
          ...
          <div className="p-5">
                    ...
                    <motion.button
                      ...
                      className={`group relative flex flex-col items-center gap-2.5 rounded-xl border-2 p-4 text-center transition-all duration-200 ${
                        isSelected
                          ...
                          : "border-[#e5e7eb] hover:border-[#534AB7]/40"
                      }`}
                      style={{
            ...
            <div className="mt-4">
              <button
                ...
                className="group flex w-full items-center justify-center gap-2.5 rounded-xl bg-[#534AB7] px-6 py-4 text-sm font-bold uppercase tracking-widest text-white transition-all duration-200 hover:bg-[#3C3489] hover:shadow-lg active:scale-[0.98]"
              >
