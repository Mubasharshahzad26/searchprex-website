...
const navLinks: NavLink[] = [
  ...
  },
  {
    ...
    dropdownItems: [
      ...
      // Add more cities here as they go live, e.g.:
      // { href: "/locations/kansas/topeka", label: "Topeka, KS" },
    ],
  },
  {
    href: "/resources",
...
export default function Nav() {
  ...
  // Smooth open/close: cancel any pending close when re-entering,
  // and delay the close slightly so moving from link -> panel doesn't flicker.
