      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="mx-auto mb-16 max-w-3xl text-center">
          ...
          <h2 className="text-3xl font-black tracking-tight text-[#0a0f2e] sm:text-4xl lg:text-5xl">
            Staying Ahead of the Curve: Winning Citations in <span className="bg-gradient-to-r from-[#534AB7] to-[#196b4d] bg-clip-text text-transparent">Google AI Overviews &amp; ChatGPT</span>
          </h2>
