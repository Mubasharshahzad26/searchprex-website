  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#2563eb] text-white shadow-lg transition-transform hover:scale-105"
            ...
            <div className="bg-[#0a0f2e] px-4 py-4">
              <div className="flex items-center gap-3">
                <div className="relative">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#2563eb] text-white font-bold">
                    S
                  </div>
                    ...
                    >
                      ...
                      <p
                        className={`mt-1 text-[10px] ${
                          message.isBot ? "text-[#94a3b8]" : "text-white/70"
                        }`}
                      >
