...
const WHATSAPP_NUMBER = "923059158010";
...
const botResponses: Record<string, string> = {
  "get free seo audit": "Great choice! Our free SEO audit includes a comprehensive analysis of your website's technical health, content quality, and backlink profile. Share your website URL or call us at +92 305 9158010 to get started.",
  ...
  "talk to an expert": "I'd love to connect you with one of our SEO specialists!\n\n1. Call us: +92 305 9158010\n2. Schedule a free consultation\n3. Email: contact@searchprex.com\n\nAvailable Mon-Fri, 9 AM - 6 PM EST.",
  "book a call": "Let's get you scheduled! Our SEO consultants offer a free 30-minute strategy session. Call +92 305 9158010 or click the phone button below.",
  "default": "Thanks for reaching out! I can help with:\n\n• Free SEO Audit\n• Pricing & Plans\n• Our Process\n• Case Studies\n\nOr call +92 305 9158010 for immediate help.",
};
...
export default function ChatWidget() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      text: "Hi, I'm Mubashar Sharif, founder of Searchprex. Looking for an SEO growth plan? Tell me about your website or goals and I'll point you in the right direction.",
      isBot: true,
      timestamp: new Date(),
    },
  ]);
  ...
  return (
    <>
      ...
      <motion.a
        ...
        className="fixed bottom-36 lg:bottom-28 right-4 sm:right-6 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg"
      ...
      <motion.button
        ...
        className="fixed bottom-20 lg:bottom-6 right-4 sm:right-6 z-50 flex items-center gap-2.5 rounded-full bg-[#0a0f2e] py-2 pl-2 pr-4 text-white shadow-lg"
      ...
      {/* Notification Dot */}
      {!isOpen && (
        <span className="fixed bottom-[8.2rem] lg:bottom-[4.7rem] right-[2.1rem] sm:right-[2.6rem] z-50 flex h-3 w-3">
            ...
            <div className="flex-shrink-0 bg-[#0a0f2e] px-4 py-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-white">Mubashar Sharif</p>
