...
// ── Unused imports commented out (restore if needed) ──
  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        {/* 02 — VIDEO PROOF (Screen recordings, case studies, GSC walkthroughs) */}
        <VideoSection />
 
        {/* 03 — PERSONA SELECTOR (Tell us about yourself) */}
        <PersonaSelector />
 
        {/* 04 — AI TOOL (Free SEO audit) */}
        <AITool />
 
        {/* 05 — TRUST BAR (Verified badges) */}
        <TrustBar />
