...
//
// It used to be `${SITE}/og/law-firm-scorecard.jpg` — public/og/ has never
// existed in this repo, so that URL 404d in the meta tags and in the structured
// data alike.
const OG_IMAGE = `${SITE}/law-firm-scorecard/opengraph-image`;
