...
// Points at the card generated by ./opengraph-image.tsx. Next feeds that file
// into this route's og:image and twitter:image on its own, so this constant is
// only here for the JSON-LD below, which Next does not populate.
//
// It used to be https://www.searchprex.com/og/intake-assistant.jpg — public/og/
// has never existed in this repo, so that URL 404d in the meta tags and in the
// structured data alike.
const OG_IMAGE = "https://www.searchprex.com/intake-assistant/opengraph-image";
