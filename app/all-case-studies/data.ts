...
export const caseStudies: CaseStudy[] = [
  {
    ...
    headline: "+75% Revenue in 2 Months: 35K Products Indexed",
    badgeColor: "#0891b2",
    badgeBg: "#ecfeff",
    video: "gFod-dTY-bg",
    featured: true,
  ...
  },
  {
    ...
    industry: "HVAC",
    location: "United States",
    headline: "Top 3 Maps Pack: Zero to Hero in 60 Days",
    badgeColor: "#059669",
    badgeBg: "#ecfdf5",
    video: "g_1TfDU4YeA",
    featured: true,
  ...
  },
  {
    ...
    headline: "+476% Clicks: Near-Zero to GSC Power House",
    badgeColor: "#185FA5",
    badgeBg: "#E6F1FB",
    video: "Y5PxSECNGP0",
    featured: true,
  ...
  },
  {
    ...
    headline: "#1 Local Ranking: 106K Impressions",
    badgeColor: "#7c3aed",
    badgeBg: "#f3e8ff",
  ...
  },
  {
    ...
    industry: "Roofing",
    location: "Texas",
    headline: "+210 Monthly Clicks: Hyper-Competitive Market",
    badgeColor: "#ea580c",
    badgeBg: "#fef3c7",
  ...
  },
  {
    ...
    industry: "Cleaning",
    location: "Clawson, MI",
    headline: "#1 Local: +95% Search Visibility",
    badgeColor: "#0369a1",
    badgeBg: "#e0f2fe",
  ...
  },
  {
    ...
    headline: "+78% Profile Views: 490 Interactions",
    badgeColor: "#059669",
    badgeBg: "#ecfdf5",
  ...
  },
  {
    ...
    headline: "Top 10 Rankings: Kitchen Remodel Keywords",
    badgeColor: "#7c3aed",
    badgeBg: "#f3e8ff",
    video: "zRcTc2HqDwU",
    featured: false,
  ...
  },
  {
    ...
    headline: "Page One: +40 Position Jump",
    badgeColor: "#dc2626",
    badgeBg: "#fee2e2",
  ...
  },
  {
    ...
    headline: "AI Search Engine: 500+ Keywords, Google AI",
    badgeColor: "#185FA5",
    badgeBg: "#E6F1FB",
    video: "La-BCpoxcII",
    featured: true,
    ...
    metrics: [
      ...
      { v: "Real-time", l: "Currency data" },
    ],
    challenge:
      "Remit Choice users searching for transfer rates, fees, and remittance guides bounced between documentation pages. Competitors offered basic info—none provided instant AI-powered answers like Google Search.",
    solution:
      "Built an AI search engine using Claude API that mimics Google's interface. Delivers AI Overview snippets, live currency data, video testimonials, and rate comparisons in search results. Optimized for Google AI Overview eligibility with intent-based content architecture.",
    outcome:
      "500+ financial keywords ranking organically. Featured in Google AI Overviews. Users get instant answers in seconds. Founder-led technical SEO + AI product thinking combined.",
  },
];
