...
import { readPageSignalsFromHtml, type PageSignals } from './verify.js';
import { scoreProspect, type ProspectScore } from './score.js';
import type { RawProspect } from './discovery/types.js';
