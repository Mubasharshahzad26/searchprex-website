...
/* 15. FOOTER TRUST & PAYMENT BADGES */
.mso-oct-footer { background: #1e293b; color: #94a3b8; border-radius: 8px; padding: 32px 36px; font-size: 12px; }
.mso-footer-grid { display: grid; grid-template-columns: 2fr 1fr 1fr 1fr 1fr; gap: 24px; margin-bottom: 24px; }
.mso-footer-col h4 { color: #ffffff; font-size: 13.5px; font-weight: 800; margin: 0 0 10px 0; }
.mso-footer-col ul { list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 6px; }
.mso-footer-col a { color: #94a3b8; text-decoration: none; transition: color 0.2s; }
.mso-footer-col a:hover { color: #f5a623; }
.mso-footer-bottom { border-top: 1px solid rgba(255,255,255,0.1); padding-top: 16px; display: flex; justify-content: space-between; align-items: center; flex-wrap: gap; }
.mso-payments { display: flex; gap: 10px; font-size: 11px; color: #cbd5e1; font-weight: 600; }
...
@media (max-width: 1080px) {
  ...
  .mso-footer-grid { grid-template-columns: 1fr 1fr; }
}
@media (max-width: 680px) {
  ...
  .mso-footer-grid { grid-template-columns: 1fr; }
  .mso-footer-bottom { flex-direction: column; gap: 10px; text-align: center; }
}
`;
...
<div class="mso-oct-container">
  ...
  <div class="mso-announcement-bar">
    <span>🎃 <strong>October Season Sale:</strong> Free Shipping over $99 · Fall Whitetail Gear Live Now <a href="https://www.michigansportsoutdoor.com/shop/">Shop Now →</a></span>
    <div class="mso-announcement-links">
      ...
      <span>·</span>
      <a href="https://www.michigansportsoutdoor.com/contact-us/">Help</a>
    </div>
  </div>
  ...
  <section class="mso-flash-deal">
    <div class="mso-flash-left">
      ...
      <p class="mso-flash-desc">Time-boxed seasonal savings on field dressing kits, super steels & EDC blades.</p>
    </div>
  ...
  <section>
    ...
    <div class="mso-cat-grid">
      ...
      <a href="https://www.michigansportsoutdoor.com/shop/" class="mso-cat-tile highlight">
        <span class="mso-cat-icon">🎃</span>
        <span class="mso-cat-name">Halloween Blades</span>
      </a>
    </div>
  </section>
  ...
  <section class="mso-promo-grid">
    ...
    <a href="https://www.michigansportsoutdoor.com/shop/" class="mso-promo-card dark">
      <div>
        <span class="mso-promo-tag">SPOOKY SEASON SPECIAL</span>
        <h3 class="mso-promo-title">Halloween Blade Collection</h3>
    ...
    <div class="mso-prod-grid">
      ...
      <a href="https://www.michigansportsoutdoor.com/shop/" class="mso-prod-card">
        ...
        <div class="mso-prod-body">
          ...
          <div class="mso-prod-stars">★★★★★ <span>(342 reviews)</span></div>
        </div>
      </a>
      ...
      <a href="https://www.michigansportsoutdoor.com/shop/" class="mso-prod-card">
        ...
        <div class="mso-prod-body">
          ...
          <div class="mso-prod-stars">★★★★★ <span>(89 reviews)</span></div>
        </div>
      </a>

      <!-- PROD 3 -->
      <a href="https://www.michigansportsoutdoor.com/shop/" class="mso-prod-card">
        <span class="mso-prod-badge hot">🔥 HOT SELLER</span>
        <div class="mso-prod-img-wrap">
        ...
        <div class="mso-prod-body">
          ...
          <div class="mso-prod-stars">★★★★★ <span>(521 reviews)</span></div>
        </div>
      </a>

      <!-- PROD 4 -->
      <a href="https://www.michigansportsoutdoor.com/shop/" class="mso-prod-card">
        <span class="mso-prod-badge low">⚠️ LOW STOCK</span>
        <div class="mso-prod-img-wrap">
        ...
        <div class="mso-prod-body">
          ...
          <div class="mso-prod-stars">★★★★★ <span>(1,240 reviews)</span></div>
        </div>
      </a>
    </div>
  </section>
  ...
  <section>
    ...
    <div class="mso-reviews-grid">
      <div class="mso-review-card">
        <div class="mso-review-stars">★★★★★</div>
      ...
      <div class="mso-review-card">
        <div class="mso-review-stars">★★★★★</div>
        <p class="mso-review-text">"The Halloween drop blade arrived faster than expected. Collector-grade packaging and zero blade play. Definitely ordering again for Christmas."</p>
  ...
  <!-- 15. FOOTER TRUST & PAYMENT SIGNALS -->
  <footer class="mso-oct-footer">
    <div class="mso-footer-grid">
      <div class="mso-footer-col">
        <h4>Michigan Sports Outdoor</h4>
        <p style="line-height:1.6;opacity:0.8;margin:0 0 10px 0;">Family-owned premier cutlery & hunting gear outfitter. Authorized dealer for 100+ American & international knife brands. Ships fast from Michigan.</p>
        <div style="font-size:16px;">🌲 🏹 🔪 🏕️</div>
      </div>
      <div class="mso-footer-col">
        <h4>Shop Cutlery</h4>
        <ul>
          <li><a href="https://www.michigansportsoutdoor.com/shop/">Hunting Knives</a></li>
          <li><a href="https://www.michigansportsoutdoor.com/shop/">Fixed Blades</a></li>
          <li><a href="https://www.michigansportsoutdoor.com/shop/">EDC Folders</a></li>
          <li><a href="https://www.michigansportsoutdoor.com/shop/">Sharpening Kits</a></li>
        </ul>
      </div>
      <div class="mso-footer-col">
        <h4>Customer Care</h4>
        <ul>
          <li><a href="https://www.michigansportsoutdoor.com/shipping-policy/">Shipping Policy</a></li>
          <li><a href="https://www.michigansportsoutdoor.com/refund-and-returns-policy/">30-Day Returns</a></li>
          <li><a href="https://www.michigansportsoutdoor.com/order-tracking/">Track Your Order</a></li>
          <li><a href="https://www.michigansportsoutdoor.com/frequently-asked-questions/">Help & FAQ</a></li>
        </ul>
      </div>
      <div class="mso-footer-col">
        <h4>Company</h4>
        <ul>
          <li><a href="https://www.michigansportsoutdoor.com/about-us/">About Us</a></li>
          <li><a href="https://www.michigansportsoutdoor.com/blog/">Knife Journal</a></li>
          <li><a href="https://www.michigansportsoutdoor.com/brands/">Authorized Brands</a></li>
          <li><a href="https://www.michigansportsoutdoor.com/contact-us/">Contact Us</a></li>
        </ul>
      </div>
      <div class="mso-footer-col">
        <h4>Legal & Policy</h4>
        <ul>
          <li><a href="https://www.michigansportsoutdoor.com/terms-and-conditions/">Terms of Service</a></li>
          <li><a href="https://www.michigansportsoutdoor.com/privacy-policy/">Privacy Policy</a></li>
          <li><a href="https://www.michigansportsoutdoor.com/knife-laws/">50-State Knife Laws</a></li>
        </ul>
      </div>
    </div>
    <div class="mso-footer-bottom">
      <span>© 2026 Michigan Sports Outdoor. All rights reserved.</span>
      <div class="mso-payments">
        <span>💳 Visa</span> · <span>Mastercard</span> · <span>Amex</span> · <span>PayPal</span> · <span>Shop Pay</span> · <span>Klarna</span>
      </div>
    </div>
  </footer>
</div>
