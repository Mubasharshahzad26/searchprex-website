...
async function deployEEATBladeHQOctoberPage() {
  ...
  // Gemini-Generated Hero Visual (with integrated USPs)
  ...
  // Authentic Google Reviewers Avatars from Live Homepage
  ...
  const avatarDigitiz = 'https://www.michigansportsoutdoor.com/wp-content/uploads/2026/08/ChIJc3vpny2NhYYR700meVMhtto_ec2bdb408878e05932d521064c5dbc56.jpg';
...
.mso-bhq-prod-title { font-size: 13.5px; font-weight: 800; color: #0f172a; line-height: 1.35; margin: 0 0 10px 0; min-height: 38px; }
.mso-bhq-prod-bottom { display: flex; justify-content: space-between; align-items: center; margin-top: auto; padding-top: 8px; border-top: 1px solid #f1f5f9; }
.mso-bhq-prod-price { font-size: 16px; font-weight: 900; color: #0f172a; }
.mso-bhq-add-cart-btn { background: #f97316; color: #ffffff; font-size: 11.5px; font-weight: 800; padding: 7px 14px; border-radius: 4px; border: none; cursor: pointer; text-transform: uppercase; transition: background 0.2s; }
.mso-bhq-add-cart-btn:hover { background: #ea580c; }

/* 9. "Knives For Everything You Do" Activity Grid */
.mso-activity-grid { display: grid; grid-template-columns: repeat(6, 1fr); gap: 14px; margin-bottom: 40px; }
.mso-activity-card { background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px 14px; text-align: center; text-decoration: none; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 10px; box-shadow: 0 2px 6px rgba(0,0,0,0.03); transition: transform 0.2s, border-color 0.2s, box-shadow 0.2s; min-height: 100px; box-sizing: border-box; }
...
/* 11. Exact Google Customer Reviews Section with H2 */
.mso-reviews-section { margin-bottom: 40px; }
.mso-reviews-header-wrap { display: flex; justify-content: space-between; align-items: center; margin-bottom: 18px; flex-wrap: wrap; gap: 12px; }
.mso-reviews-h2 { font-size: 24px; font-weight: 900; color: #0f172a; margin: 0; text-transform: uppercase; letter-spacing: -0.3px; }
.mso-reviews-badge-top { display: inline-flex; align-items: center; gap: 8px; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 20px; padding: 6px 14px; font-size: 12px; font-weight: 800; color: #0f172a; box-shadow: 0 1px 4px rgba(0,0,0,0.04); }
.mso-reviews-grid-4 { display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; }
.mso-review-card-white { background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 22px; display: flex; flex-direction: column; justify-content: space-between; box-shadow: 0 2px 8px rgba(0,0,0,0.03); transition: transform 0.2s, box-shadow 0.2s; }
.mso-review-card-white:hover { transform: translateY(-3px); box-shadow: 0 8px 20px rgba(0,0,0,0.06); }
.mso-review-user-row { display: flex; align-items: center; gap: 12px; margin-bottom: 12px; }
.mso-review-avatar { width: 44px; height: 44px; border-radius: 50%; object-fit: cover; border: 1px solid #cbd5e1; }
.mso-review-user-info { display: flex; flex-direction: column; }
.mso-review-author-name { font-size: 14px; font-weight: 800; color: #0f172a; text-decoration: none; margin: 0; }
.mso-review-time { font-size: 11px; color: #64748b; font-weight: 600; }
.mso-review-stars-gold { color: #f59e0b; font-size: 13px; margin-bottom: 10px; }
.mso-review-text-p { font-size: 13px; color: #334155; line-height: 1.55; margin: 0; font-style: normal; }
...
/* 13. Featured Videos (Exactly 2 Provided YouTube Videos in 2-Column Grid) */
.mso-videos-grid-2 { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 40px; }
.mso-video-card-lg { position: relative; height: 260px; border-radius: 8px; overflow: hidden; display: flex; flex-direction: column; justify-content: flex-end; padding: 20px; text-decoration: none; box-shadow: 0 4px 16px rgba(0,0,0,0.15); transition: transform 0.2s, box-shadow 0.2s; }
.mso-video-card-lg:hover { transform: translateY(-4px); box-shadow: 0 8px 24px rgba(0,0,0,0.22); }
.mso-video-card-lg img { position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover; }
.mso-video-overlay-lg { position: absolute; inset: 0; background: linear-gradient(180deg, rgba(0,0,0,0.15) 0%, rgba(0,0,0,0.85) 100%); }
.mso-play-btn-lg { position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 56px; height: 56px; background: #dc2626; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #ffffff; font-size: 20px; font-weight: 900; box-shadow: 0 4px 16px rgba(0,0,0,0.5); z-index: 2; transition: transform 0.2s; }
.mso-video-card-lg:hover .mso-play-btn-lg { transform: translate(-50%, -50%) scale(1.1); }
.mso-video-title-lg { position: relative; z-index: 2; font-size: 16px; font-weight: 900; color: #ffffff; margin: 0; line-height: 1.3; text-transform: uppercase; letter-spacing: -0.2px; text-shadow: 0 2px 6px rgba(0,0,0,0.6); }
...
/* 15. FAQs Section (Original Homepage FAQs) */
...
/* 17. FIXED BOTTOM-RIGHT GOOGLE VERIFIED TRUST BADGE */
...
`;
  ...
  // Write compact HTML without newline blank tags to prevent wpautop pollution
...
function scrollCats(direction) {
  ...
  console.log('Deploying refined and harmonized Blade HQ page to /october-season/ (Page #167531)...');
