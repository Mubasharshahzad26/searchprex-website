...
/* 6. Opportunities Too Good To Miss (Functional Cards with Zoom & Shadow) */
...
.mso-opp-badge { align-self: flex-start; background: #0066cc; color: #ffffff; font-size: 10px; font-weight: 900; text-transform: uppercase; padding: 4px 9px; border-radius: 4px; margin-bottom: auto; letter-spacing: 0.5px; box-shadow: 0 2px 6px rgba(0,0,0,0.2); }
...
function scrollCats(direction) {
  ...
  console.log('Deploying updated Opportunities cards to /october-season/ (Page #167531)...');
