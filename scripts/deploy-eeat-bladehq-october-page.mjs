...
.mso-videos-grid-2 > p,
.mso-videos-grid-2 p { display: none !important; margin: 0 !important; padding: 0 !important; }
...
function scrollCats(direction) {
  ...
  console.log('Deploying updated Brand Look video section & straps to /october-season/ (Page #167531)...');
