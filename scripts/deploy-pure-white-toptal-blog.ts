async function deployPureWhiteToptalBlog() {
  ...
  const blogHtml = `
<style>
  /* 0. FORCE COMPLETE PURE WHITE BACKGROUND ACROSS ENTIRE PAGE & THEME */
  html, body, #page, #content, .site-content, .entry-content, .content-area, .site-main, .post-content, .mso-blog-wrapper {
    background: #ffffff !important;
    background-color: #ffffff !important;
  }

  /* Hide any default theme page header or blue breadcrumb bars */
  ...
  /* 1. PURE WHITE HERO SECTION (NO BLUE GRADIENT/BACKGROUND) */
  .mso-toptal-hero {
    background: #ffffff !important;
  ...
  /* PURE WHITE SEARCH BAR + VOICE SEARCH */
  ...
  /* 3. HERO EDITORIAL SPOTLIGHT (PURE WHITE CARD) */
  .mso-hero-spotlight {
    background: #ffffff !important;
    border-radius: 12px;
    overflow: hidden;
  ...
  /* 4. EXACT 3 CARDS PER ROW (EQUAL HEIGHTS, PURE WHITE) */
  .mso-section-header {
    display: flex;
    justify-content: space-between;
    align-items: center;
  ...
  /* 5. PURE WHITE NEWSLETTER BAR (NO BLUE BACKGROUND) */
  .mso-newsletter-bar {
    background: #ffffff !important;
  ...
  /* 6. GEAR FEATURED: EXACTLY 1 ROW OF 4 EQUAL HORIZONTAL CARDS (PURE WHITE) */
  .mso-ecom-bridge {
    background: #ffffff !important;
...
<div class="mso-blog-wrapper">
  ...
  <!-- 1. PURE WHITE HERO BANNER WITH VOICE SEARCH -->
    ...
    <div class="mso-spotlight-content">
      <div>
        <div style="display:flex; align-items:center; gap:8px; margin-bottom:12px;">
          ...
          <span style="color:#64748b; font-size:11.5px; font-weight:600;">8 min read</span>
        </div>
  ...
  <!-- 4. 3-COLUMN EDITORIAL BENTO GRID (EXACTLY 3 CARDS PER ROW, EQUAL HEIGHTS, PURE WHITE) -->
    ...
    <div class="mso-ecom-grid">
      ...
      <div class="mso-ecom-card">
        ...
        <div>
          ...
          <a href="/product/buck-110-folding-hunter/" style="display:block; text-align:center; background:#0f172a; color:#ffffff !important; font-size:12px; font-weight:700; padding:9px 12px; border-radius:5px; text-decoration:none;">View Best Price &rarr;</a>
        </div>
      </div>
      ...
      <div class="mso-ecom-card">
        ...
        <div>
          <div style="font-size:11px; font-weight:700; color:#16a34a; margin-bottom:10px;">&bull; In Stock &bull; Ships Fast</div>
          <a href="/product/sharpi-8-in-1-diamond-sharpener/" style="display:block; text-align:center; background:#0f172a; color:#ffffff !important; font-size:12px; font-weight:700; padding:9px 12px; border-radius:5px; text-decoration:none;">View Best Price &rarr;</a>
        </div>
      </div>
      ...
      <div class="mso-ecom-card">
        ...
        <div>
          <div style="font-size:11px; font-weight:700; color:#16a34a; margin-bottom:10px;">&bull; In Stock &bull; Ships Fast</div>
          <a href="/product/lansky-turn-box-with-leather-strop-2/" style="display:block; text-align:center; background:#0f172a; color:#ffffff !important; font-size:12px; font-weight:700; padding:9px 12px; border-radius:5px; text-decoration:none;">View Best Price &rarr;</a>
        </div>
      </div>
      ...
      <div class="mso-ecom-card">
        ...
        <div>
          <div style="font-size:11px; font-weight:700; color:#16a34a; margin-bottom:10px;">&bull; In Stock &bull; Ships Fast</div>
          <a href="/product/dmt-suregrip-powered-diamond-knif/" style="display:block; text-align:center; background:#0f172a; color:#ffffff !important; font-size:12px; font-weight:700; padding:9px 12px; border-radius:5px; text-decoration:none;">View Best Price &rarr;</a>
        </div>
      </div>
...
`.trim();
  ...
  try {
    ...
    if (Array.isArray(pages) && pages.length > 0) {
      ...
      console.log(`Updating WordPress page #${pageId} to 100% Pure White design...`);
      ...
      console.log(`✅ Pure white blog page deployed successfully: ${updated.link}`);
    }
  } catch (e: any) {
    console.error('Error deploying pure white blog:', e.message);
  }
}

deployPureWhiteToptalBlog()
  .then(() => process.exit(0))
  .catch(e => {
    console.error(e);
    process.exit(1);
