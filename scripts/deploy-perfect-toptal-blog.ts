async function deployPerfectToptalBlog() {
...
<style>
  ...
  .mso-toptal-hero {
    ...
    position: relative;
    overflow: hidden;
    box-shadow: 0 10px 30px rgba(7, 21, 51, 0.25);
  }
  ...
  /* 4. EXACT 3 CARDS PER ROW GRID (TOPTAL STYLE) */
  .mso-section-header {
    display: flex;
    justify-content: space-between;
    align-items: center;
  ...
  /* 5. TOPTAL NEWSLETTER BAR (IMAGE 3) */
  .mso-newsletter-bar {
    background: #09173a;
    border-radius: 8px;
    padding: 36px 40px;
...
<div class="mso-blog-wrapper">
  ...
  <section class="mso-toptal-hero">
    ...
    <div>
      <div class="mso-shares-badge">
        <span class="mso-shares-icon"></span>
        132.3K SHARES
      </div>
    </div>
    ...
    <div class="mso-search-container">
      ...
      <input 
        ...
        onkeydown="if(event.key==='Enter'){window.location.href='/shop/?s='+encodeURIComponent(this.value);}"
      />
    </div>
  </section>
  ...
  <!-- 4. 3-COLUMN EDITORIAL BENTO GRID (EXACTLY 3 CARDS PER ROW AS REQUESTED) -->
  ...
  <!-- 5. TOPTAL NEWSLETTER STRIP (EXACTLY AS SHOWN IN USER IMAGE 3) -->
  ...
  <!-- 6. IN-ARTICLE E-COMMERCE BRIDGE ("TESTED GEAR AVAILABLE IN STORE") -->
  <section class="mso-ecom-bridge">
    <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; margin-bottom:18px; border-bottom:1px solid #e2e8f0; padding-bottom:12px;">
      <div>
        ...
        <h3 style="font-size:20px; font-weight:800; color:#0f172a; margin:4px 0 0 0;">Gear Featured in Our Field Guides</h3>
      </div>
    ...
    <div class="mso-ecom-grid">
      ...
      <div class="mso-ecom-card">
        <div>
          <a href="/product/buck-110-folding-hunter/" style="display:block; text-align:center;">
          ...
          <div style="font-size:10px; font-weight:800; text-transform:uppercase; color:#16a34a; margin-bottom:3px;">Whitetail Classic</div>
          <div style="font-size:12.5px; font-weight:700; color:#0f172a; margin:0 0 6px 0; line-height:1.3;">
            <a href="/product/buck-110-folding-hunter/" style="color:#0f172a; text-decoration:none;">Buck 110 Folding Hunter</a>
          </div>
        </div>
        <div>
          <div style="font-size:11px; font-weight:700; color:#16a34a; margin-bottom:8px;">&bull; In Stock &bull; Ships Fast</div>
          <a href="/product/buck-110-folding-hunter/" style="display:block; text-align:center; background:#0f172a; color:#ffffff; font-size:11.5px; font-weight:700; padding:7px 10px; border-radius:5px; text-decoration:none;">View Best Price &rarr;</a>
        </div>
      </div>
      ...
      <div class="mso-ecom-card">
        <div>
          <a href="/product/sharpi-8-in-1-diamond-sharpener/" style="display:block; text-align:center;">
          ...
          <div style="font-size:10px; font-weight:800; text-transform:uppercase; color:#16a34a; margin-bottom:3px;">Pack Sharpener</div>
          <div style="font-size:12.5px; font-weight:700; color:#0f172a; margin:0 0 6px 0; line-height:1.3;">
      ...
      <div class="mso-ecom-card">
        <div>
          <a href="/product/lansky-turn-box-with-leather-strop-2/" style="display:block; text-align:center;">
          ...
          <div style="font-size:10px; font-weight:800; text-transform:uppercase; color:#b45309; margin-bottom:3px;">Camp Sharpener</div>
          <div style="font-size:12.5px; font-weight:700; color:#0f172a; margin:0 0 6px 0; line-height:1.3;">
      ...
      <div class="mso-ecom-card">
        <div>
          <a href="/product/dmt-suregrip-powered-diamond-knif/" style="display:block; text-align:center;">
          ...
          <div style="font-size:10px; font-weight:800; text-transform:uppercase; color:#0284c7; margin-bottom:3px;">Diamond Bench Hone</div>
          <div style="font-size:12.5px; font-weight:700; color:#0f172a; margin:0 0 6px 0; line-height:1.3;">
...
`.trim();
  ...
  try {
    console.log('Fetching existing page for slug "blog"...');
    ...
    if (Array.isArray(pages) && pages.length > 0) {
      ...
      console.log(`✅ Blog page updated successfully: ${updated.link}`);
    } else {
      ...
      console.log(`✅ Blog page created successfully: ${created.link}`);
    }
  } catch (e: any) {
    console.error('Error deploying blog page:', e.message);
  }
}

deployPerfectToptalBlog()
  .then(() => process.exit(0))
  .catch(e => {
    console.error(e);
    process.exit(1);
